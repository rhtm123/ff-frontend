...
export default function OwnerTenantInfoCard({ data, type , editAllow=true, refreshCount, setRefreshCount }){
    ...
    const [formData, setFormData] = useState(
      {"role": data.memberId.role, isCommitteeMember: data.memberId.isCommitteeMember}
    )
    ...
    return (
      <tr>
        <th>
        {editMode ? <span>{member.name}</span>:
