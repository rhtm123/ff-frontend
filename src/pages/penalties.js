...
export default function Penalty() {
    ...
    const deletePenalty = async (penalty) => {
        ...
        try{
            ...
            let dataArray = penalties.filter(item => item._id !== deletedPenalty.penalty._id);
        ...
        <div>
            <div className="grid lg:grid-cols-2">
                ...
                <div className="p-8">
                    ...
                    <button className="btn" onClick={()=>document.getElementById('my_modal_3').showModal()}>Impose Penalty</button>
                ...
                <div className="p-8">
                    {/* Open the modal using document.getElementById('ID').showModal() method */}
                    <button className="btn bg-accent" onClick={()=>document.getElementById('my_modal_2').showModal()}>Add Penalty</button>
                    <dialog id="my_modal_2" className="modal">
                        <div className="modal-box">
                            ...
                            <div className="modal-action flex items-center justify-center">
                                <form className="w-full" id="addNewPenalty"  onSubmit={addNewPenalty}>
                                    <div className="mb-4">
                                    <label>
                                        Name:
                                        <input
                                    ...
                                    <div className="modal-action">
                                        {!submitting && <button type="submit" className="btn">
                                            Add Penalty
                                        </button>}
                    ...
                    <div className="container mx-auto">              
                        ...
                        <div key={penalty._id} className="card w-100 bg-base-100 shadow-xl border my-4">
                            
                            <button className="btn btn-primary" onClick={()=>deletePenalty(penalty)}>Delete</button> 
