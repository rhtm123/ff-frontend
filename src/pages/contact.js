    ...
    <div class="container px-6 py-10 mx-auto">
        <div class="lg:flex lg:items-center lg:-mx-10">
                ...
                <form class="mt-12">
                    <div class="-mx-2 md:items-center md:flex">
                        ...
                        <div class="flex-1 px-2 mt-4 md:mt-0">
                            ...
                            <input type="email" placeholder="" class="block w-full px-5 py-3 mt-2   bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900  dark:border-gray-700 focus:border-blue-400 dark:focus:border-b" />
                        </div>
                    </div>
            ...
            <div class="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                <img class="hidden object-cover mx-auto rounded-full lg:block shrink-0 w-96 h-96" src="/images/contact.jpeg" alt=""/>
                ...
                <div class="mt-6 space-y-8 md:mt-8">
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2 ">(257) 563-7401</span>
                    </p>
                    ...
                    <p class="flex items-start -mx-2">
                        ...
                        <span class="mx-2">Bhagvadgita@gmail.com</span>
                    </p>
                </div>
                ...
                <div class="mt-6 w-80 md:mt-8">
                    ...
                    <div class="flex mt-4 -mx-1.5 ">
                        <a class="mx-1.5 dark:hover:text-blue-400 transition-colors duration-300 transform hover:text-blue-500" href="#">
